...
public final class NexoriSpectatorPickupSpatialRestoreSystem extends TickingSystem<EntityStore> {
    ...
    public NexoriSpectatorPickupSpatialRestoreSystem(
    ...
    public void tick(float delta, int parallelIndex, Store<EntityStore> store) {
        ...
        spatialProbe.restore(store, playerSpatialResource);
    }
}
