...
public final class NexoriRecoveryEntryElement extends ChoiceElement {

    private final String name;
    private final String description;
    private final boolean selected;

    public NexoriRecoveryEntryElement(
        @Nonnull String name,
    ...
    public void addButton(
        ...
        commands.append("#RecoveryList", "Pages/Nexori/NexoriPeerEntry.ui");
