...
public final class NexoriSpectatorPickupSpatialFilterSystem extends TickingSystem<EntityStore> {

    private final NexoriSpectatorPickupSpatialProbe spatialProbe;
    ...
    public NexoriSpectatorPickupSpatialFilterSystem(
        @Nonnull NexoriSpectatorPickupSpatialProbe spatialProbe,
    ...
    public void tick(float delta, int parallelIndex, Store<EntityStore> store) {
        ...
        spatialProbe.filterTrackedSpectators(store, playerSpatialResource);
    }
}
