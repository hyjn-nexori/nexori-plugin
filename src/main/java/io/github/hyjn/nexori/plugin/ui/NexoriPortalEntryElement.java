...
public final class NexoriPortalEntryElement extends ChoiceElement {

    private final String name;
    private final String description;
    private final boolean selected;

    public NexoriPortalEntryElement(
        @Nonnull String name,
    ...
    public void addButton(
        ...
        commands.append("#PortalList", "Pages/Nexori/NexoriPeerEntry.ui");
