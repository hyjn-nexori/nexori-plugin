...
public final class NexoriTargetEntryElement extends ChoiceElement {

    private final String name;
    private final String description;
    private final boolean selected;

    public NexoriTargetEntryElement(
        @Nonnull String name,
    ...
    public void addButton(
        ...
        commands.append("#TargetList", "Pages/Nexori/NexoriPeerEntry.ui");
